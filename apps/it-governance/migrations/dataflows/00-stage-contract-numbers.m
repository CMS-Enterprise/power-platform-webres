...
shared FileName = "system_intake_contract_numbers.csv" meta [IsParameterQuery = true, IsParameterQueryRequired = false, Type = type text];
shared #"system_intake_contract_numbers 1" = let
