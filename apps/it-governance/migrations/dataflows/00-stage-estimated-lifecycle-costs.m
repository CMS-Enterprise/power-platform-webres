...
shared FileName = "estimated_lifecycle_costs.csv" meta [IsParameterQuery = true, IsParameterQueryRequired = false, Type = type text];
shared estimated_lifecycle_costs = let
