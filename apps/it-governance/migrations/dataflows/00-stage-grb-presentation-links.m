...
shared FileName = "system_intake_grb_presentation_links.csv" meta [IsParameterQuery = true, IsParameterQueryRequired = false, Type = type text];
shared #"system_intake_grb_presentation_links 2" = let
