section Section1;
shared trb_admin_notes_trb_admin_note_insights_links = let
  Source = Csv.Document(Web.Contents("https://cmsgovonline-my.sharepoint.com/personal/wyatt_emme_cms_hhs_gov/Documents/TRB%20Mapping%20File/trb_admin_notes_trb_admin_note_insights_links.csv"), [Delimiter = ",", Columns = 8, QuoteStyle = QuoteStyle.None]),
  ...
  #"Changed column type" = Table.TransformColumnTypes(
    #"Replace NULLs", 
    {
      ...
      {"trb_admin_note_id", type text}, 
      {"trb_guidance_letter_insight_id", type text}, 
