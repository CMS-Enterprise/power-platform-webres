section Section1;
shared trb_guidance_letter_insights = let
  Source = Csv.Document(Web.Contents("https://cmsgovonline-my.sharepoint.com/personal/wyatt_emme_cms_hhs_gov/Documents/TRB%20Mapping%20File/trb_guidance_letter_insights.csv"), [Delimiter = ",", Columns = 12, QuoteStyle = QuoteStyle.None]),
