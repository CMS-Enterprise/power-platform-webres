section Section1;
shared trb_admin_notes_trb_request_documents_links = let
  Source = Csv.Document(Web.Contents("https://cmsgovonline-my.sharepoint.com/personal/wyatt_emme_cms_hhs_gov/Documents/TRB%20Mapping%20File/trb_admin_notes_trb_request_documents_links.csv"), [Delimiter = ",", Columns = 8, QuoteStyle = QuoteStyle.None]),
  ...
  #"Changed column type" = Table.TransformColumnTypes(
    #"Replace NULLs", 
    {
      ...
      {"trb_request_document_id", type text}, 
