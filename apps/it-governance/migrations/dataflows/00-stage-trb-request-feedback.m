section Section1;
shared trb_request_feedback = let
  Source = Csv.Document(Web.Contents("https://cmsgovonline-my.sharepoint.com/personal/wyatt_emme_cms_hhs_gov/Documents/TRB%20Mapping%20File/trb_request_feedback.csv"), [Delimiter = ",", Columns = 10, QuoteStyle = QuoteStyle.None]),
  ...
  #"Changed column type" = Table.TransformColumnTypes(
    #"Replace NULLs", 
    {
      ...
      {"feedback_message", type text}, 
      {"copy_trb_mailbox", type logical}, 
      {"notify_eua_ids", type text}, 
      {"action", type text}, 
