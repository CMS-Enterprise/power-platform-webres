...
shared Requests = let
    ...
    WithSkipContactCreation = Table.AddColumn(
        WithQA,
        "cr3ee_skiprequestercontactcreation",
        each true,
        type logical
    ),
