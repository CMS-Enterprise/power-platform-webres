...
shared ExistingSolutions =
    let
        ...
        SelectedColumns = Table.SelectColumns(
            Solutions,
            {"cr69a_businesscasesolutionid", "new_request", "cr69a_solution_type", "cr69a_batchid"},
            MissingField.Error
        )
    in
        SelectedColumns;
